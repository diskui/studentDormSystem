...
<html>
    ...
    String dormheader = request.getParameter("dormheader");
    String dormnumber = request.getParameter("dormnumber");
    String dormtype = request.getParameter("dormtype");
    String dormheaderphone = request.getParameter("dormheaderphone");
            ...
            <form class="layui-form">
                ...
                <div class="layui-form-item" style="margin-top: 5px;">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="studentnumber" name="studentnumber" value="<%=studentnumber%>" required="" lay-verify="required"
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="name" name="name" required="" lay-verify="required"value="<%=studentname%>"
                        autocomplete="off" class="layui-input"style="width: 200px;" disabled="disabled">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="dormheader" name="dormheader" required="" lay-verify="required"value="<%=dormheader%>"
                        autocomplete="off" class="layui-input"style="width: 200px;">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="dormnumber" name="dormnumber" required="" lay-verify="required"value="<%=dormnumber%>"
                        autocomplete="off" class="layui-input"style="width: 200px;">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="dormtype" name="dormtype" required="" lay-verify="required"value="<%=dormtype%>"
                        autocomplete="off" class="layui-input"style="width: 200px;">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="dormheaderphone" name="dormheaderphone" required="" lay-verify="required"value="<%=dormheaderphone%>"
                        autocomplete="off" class="layui-input"style="width: 200px;">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="phone" name="phone" required="" lay-verify="required"value="<%=phone%>"
                        autocomplete="off" class="layui-input"style="width: 200px;">
                    </div>
                </div>
        ...
        layui.use(['form','layer','upload'], function(){//layui.use
          ...
          form.on('submit(add)', function(data){ //form.on
            ...
            layer.confirm('确定要修改吗？',function(index){ 
                ...
                window.setTimeout("window.location = 'DormListChange?studentnumber="+studentnumber+"&area="+area+"&build="+build+"&room="+room+"&name="+name+"&dormheader="+dormheader+"&dormnumber="+dormnumber+"&dormtype="+dormtype+"&dormheaderphone="+dormheaderphone+"&phone="+phone+"'",10); 
