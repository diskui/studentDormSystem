...
<html>
    ...
    ArrayList<Repair> repairlist = repair.findAllPipeline();
    %>
        <div class="x-nav">
            <span class="layui-breadcrumb">
              <a><cite>管道报修管理列表</cite></a>
            </span>
        ...
        <script>
            ...
            function commemt_del(obj,area,build,room,description){
                layer.confirm('确定要删除此信息吗？',function(index){
                    ...
                    window.setTimeout("window.location = 'PipelineRepairDel?area="+area+"&build="+build+"&room="+room+"&description="+description+"'",1100);
                });
            }
