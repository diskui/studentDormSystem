    ...
    <body>
        ...
        <div class="x-body">   
           <blockquote class="layui-elem-quote">
        		<span style="font-family: SimHei;font-size: 20px;">电器报修！</span>
   		    </blockquote>
                    ...
                    <form class="layui-form layui-form-pane" action="">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block" style="padding-top: 5px;">
                                <input type="checkbox" name="空调损坏" value="空调" title="空调损坏" > 
                                <input type="checkbox" name="电灯损坏" value="电灯" title="电灯损坏" >
                                <input type="checkbox" name="电风扇损坏" value="电风扇" title="电风扇损坏" >
                                <input type="checkbox" name="开关插座损坏" value="插座" title="插座损坏" >         
            ...
            layui.use(['laydate','element','layer','form'], function(){
             ...
             //监听提交
              form.on('submit(*)', function(data){
                console.log(data);
                //发异步，把数据提交给php
               var value1 = document.getElementsByName("空调损坏")[0].checked;
                var value2 = document.getElementsByName("电灯损坏")[0].checked;
                var value3 = document.getElementsByName("电风扇损坏")[0].checked;
                var value4 = document.getElementsByName("开关插座损坏")[0].checked;
                ...
                else
                {
                    ...
                    var description = $("#description").val();
               		...
               		window.setTimeout("window.location = 'ElectricappRepair?area="+area+"&build="+build+"&room="+room+"&description="+description+"'",5000);
                }              
                return false;
              });
