...
@WebServlet("/PipelineRepair")
public class PipelineRepair extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RepairInterface pipeline = DaoFactory.getRepairMethod();
		pipeline.addPipeline(area, build, room, description, dormheader);
		response.sendRedirect("Pipeline_repair.jsp");
	}
