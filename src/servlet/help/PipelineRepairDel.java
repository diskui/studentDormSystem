...
@WebServlet("/PipelineRepairDel")
public class PipelineRepairDel extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		repair.deletePipeline(area, build, room, description);
		response.sendRedirect("PipelineRepair_List.jsp");
	}
