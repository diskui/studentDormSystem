    ...
    <body>
        ...
        <div class="x-body">   
           <blockquote class="layui-elem-quote">
        		<span style="font-family: SimHei;font-size: 20px;">门窗桌椅报修！</span>
   		    </blockquote>
                    ...
                    <form class="layui-form layui-form-pane" action="">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block" style="padding-top: 5px;">
                                <input type="checkbox" name="书桌损坏" value="书桌" title="书桌损坏" > 
                                <input type="checkbox" name="座椅损坏" value="座椅" title="座椅损坏" > 
                                <input type="checkbox" name="床板损坏" value="床板" title="床板损坏" >
                                <input type="checkbox" name="房门损坏" value="房门" title="房门损坏" >
                                <input type="checkbox" name="窗户损坏" value="窗户" title="窗户损坏" >         
            ...
            layui.use(['laydate','element','layer','form'], function(){
             ...
             //监听提交
              form.on('submit(*)', function(data){
                console.log(data);
                //发异步，把数据提交给php
               var value1 = document.getElementsByName("书桌损坏")[0].checked;
                var value2 = document.getElementsByName("座椅损坏")[0].checked;
                var value3 = document.getElementsByName("床板损坏")[0].checked;
                var value4 = document.getElementsByName("房门损坏")[0].checked;
                var value5 = document.getElementsByName("窗户损坏")[0].checked;
                var value6 = document.getElementsByName("其他")[0].checked;
                ...
                else
                {
                    ...
                    var description = $("#description").val();
               		...
               		window.setTimeout("window.location = 'FurnitureRepair?area="+area+"&build="+build+"&room="+room+"&description="+description+"'",5000);
                }              
                return false;
              });
