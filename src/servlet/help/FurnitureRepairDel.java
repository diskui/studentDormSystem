...
@WebServlet("/FurnitureRepairDel")
public class FurnitureRepairDel extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		repair.deleteFurniture(area, build, room, description);
		response.sendRedirect("FurnitureRepair_List.jsp");
	}
