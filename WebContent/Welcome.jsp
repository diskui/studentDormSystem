 ...
 <body>
  ...
  <div class="x-body"><!-- 页面框架 -->
    ...
    <blockquote class="layui-elem-quote"><!-- 欢迎 -->
        <span><%=student.getStudentname()%>，欢迎使用学生宿舍管理系统！</span>
    </blockquote><!-- @欢迎 -->
    ...
    <div class="row"><!-- 宿舍信息 -->
    	...
    	<section class="panel bgys"><!-- 灰色框 -->
    		<div style="font-size: 30px; margin-left: 40px; font-family: STCaiyun;margin-top: 28px;font-weight: bold;">宿舍信息：</div>
    	</section><!-- @灰色框 -->
    	</div><!-- @宿舍信息： -->
        ...
        <div class="col-xs-6 col-sm-4 col-md-2"><!-- 人数 -->
            <section class="panel bgys"><!-- 灰色框 -->
                ...
                <div class="value tab-menu" bind="1" style="margin-right: 45px;"><!-- 信息 -->
                    <a href="javascript:;" data-url="user-info.html" data-parent="true" data-title="宿舍人数"><i class="iconfont " data-icon=""></i> <h1><%=student.getDormnumber()%></h1> </a>
                    <a href="javascript:;" data-url="user-info.html" data-parent="true" data-title="宿舍人数"> <i class="iconfont " data-icon=""></i><span>宿舍人数</span></a>
                </div><!-- @信息 -->
            </section><!-- @灰色框 -->
        </div><!-- @人数 -->
        ...
        <div class="col-xs-6 col-sm-4 col-md-2 ">
            <section class="panel bgys">
                ...
                <div class="value tab-menu" bind="1"style="margin-right: 45px;margin-top: 13px;">
                    <a href="javascript:;" data-url="user-info.html" data-parent="true" data-title="苑区"> <i class="iconfont " data-icon=""></i> <h1 style="font-size: 30px;"><%=student.getArea()%></h1> </a>
        ...
        <div class="col-xs-6 col-sm-4 col-md-2 ">
            <section class="panel bgys">
                ...
                <div class="value tab-menu" bind="1"style="margin-right: 45px;">
                    <a href="javascript:;" data-url="user-info.html" data-parent="true" data-title="楼号"> <i class="iconfont " data-icon=""></i> <h1><%=student.getBuild()%></h1> </a>
        ...
        <div class="col-xs-6 col-sm-4 col-md-2 ">
            <section class="panel bgys">
                ...
                <div class="value tab-menu" bind="1"style="margin-right: 45px;">
                    <a href="javascript:;" data-url="user-info.html" data-parent="true" data-title="宿舍号"> <i class="iconfont " data-icon=""></i> <h1><%=student.getRoom()%></h1> </a>
                    <a href="javascript:;" data-url="user-info.html" data-parent="true" data-title="宿舍号"> <i class="iconfont " data-icon=""></i><span>宿舍号</span></a>
                </div>
            </section>
        </div>
        ...
        <div class="col-xs-6 col-sm-4 col-md-2 ">
            <section class="panel bgys">
                ...
                <div class="value tab-menu" bind="1"style="margin-right: 45px;">
                    <a href="javascript:;" data-url="user-info.html" data-parent="true" data-title="面积"> <i class="iconfont " data-icon=""></i> <h1>30㎡</h1> </a>
                    <a href="javascript:;" data-url="user-info.html" data-parent="true" data-title="面积"> <i class="iconfont " data-icon=""></i><span>面积</span></a>
                </div>
            </section>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <section class="panel">
                <div class="panel-heading">苑区年级分布(人)</div>
                <div class="panel-body">
        ...
        series: [
            {
                ...
                type:'line',
                /*stack: '总量',*/
                data:[<%=electricitybill.getWeek1()%>,<%=electricitybill.getWeek2()%>,<%=electricitybill.getWeek3()%>,
                	<%=electricitybill.getWeek4()%>,<%=electricitybill.getWeek5()%>,<%=electricitybill.getWeek6()%>,
                	<%=electricitybill.getWeek7()%>]              
            },
            {
                name:'苑区平均用电量',
                type:'line',
    ...
    var option = {
        ...
        series: [{
            ...
            data: [<%=waterbill.getWeek1()%>, <%=waterbill.getWeek2()%>, <%=waterbill.getWeek3()%>, <%=waterbill.getWeek4()%>, 
            	...
            	<%=waterbill.getWeek9()%>, <%=waterbill.getWeek10()%>]
        }]
    };
    // 使用刚指定的配置项和数据显示图表。
    myChart.setOption(option);
