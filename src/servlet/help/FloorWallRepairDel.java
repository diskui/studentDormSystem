...
@WebServlet("/FloorWallRepairDel")
public class FloorWallRepairDel extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		repair.deleteFloorwall(area, build, room, description);
		response.sendRedirect("FloorWallRepair_List.jsp");
	}
