    ...
    <body>
        ...
        <div class="x-body">   
           <blockquote class="layui-elem-quote">
        		<span style="font-family: SimHei;font-size: 20px;">投诉举报宿舍！（下面填写所要举报的宿舍）</span>
   		    </blockquote>
        ...
        <script>
            layui.use(['form','layer'], function(){
              ...
              form.on('submit(add)', function(data){
                ...
                window.setTimeout("window.location = 'ComplainDorm?area="+area+"&build="+build+"&room="+room+"&description="+description+"&phone="+phone+"&email="+email+"'",1100);
                return false;
              });
