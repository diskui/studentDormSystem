    ...
    <body>
        ...
        <div class="x-body">   
           <blockquote class="layui-elem-quote">
        		<span style="font-family: SimHei;font-size: 20px;">地板墙体报修！</span>
   		    </blockquote>
                    ...
                    <form class="layui-form layui-form-pane" action="">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block" style="padding-top: 5px;">
                                <input type="checkbox" name="地板损坏" value="地板" title="地板损坏" > 
                                <input type="checkbox" name="墙体损坏" value="墙体" title="墙体损坏" >        
            ...
            layui.use(['laydate','element','layer','form'], function(){
             ...
             //监听提交
              form.on('submit(*)', function(data){
                console.log(data);
                //发异步，把数据提交给php
               var value1 = document.getElementsByName("地板损坏")[0].checked;
                var value2 = document.getElementsByName("墙体损坏")[0].checked;
                var value3 = document.getElementsByName("其他")[0].checked;
                ...
                else
                {
                    ...
                    var description = $("#description").val();
               		...
               		window.setTimeout("window.location = 'FloorWallRepair?area="+area+"&build="+build+"&room="+room+"&description="+description+"'",5000);
                }              
                return false;
              });
